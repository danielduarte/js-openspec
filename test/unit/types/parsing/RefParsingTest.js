...
import RefSpec from "../../../../src/OpenSpec/Spec/Type/RefSpec";
...
{
    let specData = { type: 'ref', spec: 'Link' };
...
describe('RefParsingTest', function() {
    ...
    it('testSpecRequiredFields', function() {
        ...
        fields.sort();
        assert(equal_arrays(fields, ['spec', 'type']));
    });
